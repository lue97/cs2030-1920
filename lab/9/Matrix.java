...
class Matrix {
   ...
   * @return The resulting matrix m1 * m2
   */
  public static Matrix recursiveMultiply(Matrix m1, Matrix m2, int m1Row, int m1Col, int m2Row, int m2Col, int dimension) {
    ...
    Matrix result = new Matrix(dimension);
    MatrixMultiplication a11b11t = new MatrixMultiplication(m1, m2, m1Row, m1Col, m2Row, m2Col, size);
    MatrixMultiplication a12b21t = new MatrixMultiplication(m1, m2, m1Row, m1Col + size, m2Row + size, m2Col, size);

    a11b11t.fork();

    MatrixMultiplication a11b12t = new MatrixMultiplication(m1, m2, m1Row, m1Col, m2Row, m2Col + size, size);
    MatrixMultiplication a12b22t = new MatrixMultiplication(m1, m2, m1Row, m1Col + size, m2Row + size, m2Col + size, size);

    a11b12t.fork();

    MatrixMultiplication a21b11t = new MatrixMultiplication(m1, m2, m1Row + size, m1Col, m2Row, m2Col, size);
    MatrixMultiplication a22b21t = new MatrixMultiplication(m1, m2, m1Row + size, m1Col + size, m2Row + size, m2Col, size);

    a21b11t.fork();

    MatrixMultiplication a21b12t = new MatrixMultiplication(m1, m2, m1Row + size, m1Col, m2Row, m2Col + size, size);
    MatrixMultiplication a22b22t = new MatrixMultiplication(m1, m2, m1Row + size, m1Col + size, m2Row + size, m2Col + size, size);

    a21b12t.fork();

	Matrix a22b22 = a22b22t.compute();
